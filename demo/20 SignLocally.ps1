...
$result = Set-AuthenticodeSignature -FilePath .\Test.ps1 -Certificate $cert -HashAlgorithm SHA256
$result

'Get-Date' | Out-File -FilePath .\TestWithTimeStamp.ps1
$result = Set-AuthenticodeSignature -FilePath .\TestWithTimeStamp.ps1 -Certificate $cert -HashAlgorithm SHA256 -TimestampServer http://timestamp.digicert.com
$result
